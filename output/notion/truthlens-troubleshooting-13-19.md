# TruthLens 트러블슈팅 13~19번 (노션 추가분)

> 저장소 `docs/TROUBLESHOOTING.md`에서 그대로 옮긴 것. 노션 문서에는 1~12번만 있어 나머지 7건을 붙여넣기용으로 뽑아둠.
> 출처: github.com/jjssspark/TruthLens — `docs/TROUBLESHOOTING.md`
> 뽑은 날짜: 2026-08-17
